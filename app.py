...
class MockWhisperModel:
    def transcribe(self, audio_path):
        """
        Mock transcription function that returns a predefined transcription.
        In a real application, this would use OpenAI's Whisper model.
        """
        ...
        return {
            "text": "This is a mock transcription of the YouTube video. In a real application, this would be the actual transcription generated by OpenAI's Whisper model.",
            "segments": [
                {
                    "id": 0,
                    "start": 0.0,
                ...
                },
                {
                    ...
                    "start": 5.0,
                    "end": 10.0,
                    "text": "In a real application, this would be the actual transcription generated by OpenAI's Whisper model."
                }
            ]
        }
...
logger.info(f"Using mock Whisper model (simulating {model_size})")
